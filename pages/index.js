        ...
        <>
            ...
            <section
                ...
                <h2 style={{ fontSize: "4.25rem", marginBottom: "2rem", color: "white", fontWeight: "400", fontFamily: '"Bebas Neue", serif' }}>
                    What is &nbsp;<span style={{ color: "#eb0028", fontFamily: 'Helvetica, Arial, sans-serif', fontWeight: "bold", letterSpacing: "-2px" }}>TED<sup style={{ fontSize: "0.6em", letterSpacing: "0", marginLeft: "2px", verticalAlign: "super" }}>x</sup></span>
                </h2>
                <p style={{ maxWidth: "800px", margin: "0 auto", fontSize: "1.3rem", lineHeight: "1.6", color: "white", fontFamily: '"Outfit", sans-serif', textAlign: "justify" }}>
                    In the spirit of ideas worth spreading, TED has created a program called TEDx. TEDx is a program of local, self-organized events that bring people together to share a TED-like experience. Our event is called TEDxShivNadarUniversity, where x = independently organized TED event. At our TEDxShivNadarUniversity event, TEDTalks video and live speakers will combine to spark deep discussion and connection in a small group. The TED Conference provides general guidance for the TEDx program, but individual TEDx events, including ours, are self-organized.
                </p>
