    ...
    <div className='AboutUs'>
      ...
      <div className='AboutUs__content'>
        <div className='AboutUs__content--text'>
          After last year&apos;s conference gave us some of the finest moments of awe, positivity, and euphoria, from speakers with riveting talks to rhapsodic performances that left the audience elated, from bustling pre-functional activities to a finger-licking food menu that left the audiences wanting more.. we are back again this year with all that and more! <br /> <br /> We&apos;ve had a day filled with 11 exceptional speakers and mind-blowing performances for our 6th edition, activities before the conference that kept our audience on their hooked, along with a high-quality buffer lunch, high tea, and a dessert bar. With that in mind... <br /> <br /> {!isSmall && <p className='AboutUs__content--text'>We bring the 7th edition of TEDxShivNadarUniversity to happening this year with a vibrant theme and a lineup of brilliant speakers, fun activities, and other exciting things!! We&apos;lve had the fortune of hosting great and well-received conferences so far, and we promise that this conference will be just that, if not more. Can&apos;t wait to see you all on G-Block! Stay tuned for more updates!! </p>}
        </div>
