    ...
    <div className='AboutUs'>
      ...
      <div className='AboutUs__content'>
        <div className='AboutUs__content--text'>
          ...
          <p>
            At TEDxShiv Nadar University, we believe that Ideas Change Everything. Mosaic celebrates the power of bringing together our community, local voices, and global perspectives to spark conversations that shape the future. Because every idea is a piece of something bigger.
          </p>
        </div>
