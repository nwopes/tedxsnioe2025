...
function PastConfSlider() {
    ...
    return (
        <section id="slider">
            <input value="1" type="radio" name="slider" id="s1" defaultChecked={checked === "1"} onClick={() => handleClick("1")} />
            <input value="2" type="radio" name="slider" id="s2" defaultChecked={checked === "2"} onClick={() => handleClick("2")} />
            <input value="3" type="radio" name="slider" id="s3" defaultChecked={checked === "3"} onClick={() => handleClick("3")} />
            <input value="4" type="radio" name="slider" id="s4" defaultChecked={checked === "4"} onClick={() => handleClick("4")} />
            <input value="5" type="radio" name="slider" id="s5" defaultChecked={checked === "5"} onClick={() => handleClick("5")} />
